...
function Home() {
  return (
    <main>
      <ImgBlock imgUrl="../../assets/images/coffeePress.jpg" showTxtOverlay="false" quote="Lyst på" title="verdens beste" quote2="jobb?"/> 
      ...
      <ImgBlock imgUrl="../../assets/images/coffeeHeart.jpg" showTxtOverlay="false"  hideButtonWhite="true" customClass="imgBlockMobile"/>
      <PreviewBlock title="Anbefalte produkter" showKaffe="false" showCarousel="false" SmallProductsLib="true"/>
      <ImgBlock imgUrl="../../assets/images/coffeeshop.jpg" showTxtOverlay="false" hideButtonWhite="true" customClass="imgBlockMobile"/>
